...
export const ProfileSvg = () => (
	<svg viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
		<circle cx='11.579' cy='7.278' r='4.778' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
		<path
			clipRule='evenodd'
...
export const FavoriteSvg = () => (
	<svg viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
		<path
			...
			strokeLinejoin='round'
		/>
		<path d='M15.74 7.053a2.782 2.782 0 011.916 2.422' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
	</svg>
)

export const DeliveryAddressSvg = () => (
	<svg viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
		<path
			clipRule='evenodd'
			...
			strokeLinejoin='round'
		/>
		<circle cx='11.917' cy='10.539' r='2.461' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
	</svg>
)

export const OrdersHistorySvg = () => (
	<svg viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
		<path
