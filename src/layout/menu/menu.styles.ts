...
export const StyledMenu = styled.menu(({ show }: { show: boolean }) => [
  tw`font-body text-gray-700 fixed flex flex-col justify-between w-full h-full max-w-sm m-0 px-4 pt-8 pb-20 md:pb-24 xl:pb-28 bg-white shadow-lg border-r-2 border-gray-200 transition-all duration-500 transform dark:bg-gray-900 dark:border-gray-600`,
